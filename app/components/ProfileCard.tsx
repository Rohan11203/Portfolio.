...
const ProfileCard = () => {
  return (
    <div className="bg-black text-white p-6 rounded-lg w-[330px] md:w-full">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-300 text-sm">
          Hello, I&apos;m Rohan! a 21 year old developer based in Mumbai -
          India.
        </p>
      </div>
      ...
      <div className="border-t border-gray-800 pt-3 flex justify-between items-start mt-auto">
        ...
        <div className="text-right">
          ...
          <div className="text-gray-500 text-xs">04/03/2025, 08:42:49 PM</div>
        </div>
      </div>
    </div>
  );
